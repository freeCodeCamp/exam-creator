import { Button, Field, Text, Input, Dialog } from "@chakra-ui/react";
        ...
        <Dialog.Content backgroundColor={"gray.700"} color={"white"}>
          ...
          <Dialog.Body>
            {seedExamToStagingMutation.isPending ? (
              ...
              <Text>
                This is a potentially destructive action. Are you sure you want
                to seed the staging database with the selected exams?
              </Text>
            )}
        ...
        <Dialog.Content backgroundColor={"gray.700"} color={"white"}>
          ...
          <Dialog.Body>
            {seedExamToProductionMutation.isPending ? (
              ...
              <Text>
                This is a potentially destructive action. Are you sure you want
                to seed the production database with the selected exams?
              </Text>
            )}
